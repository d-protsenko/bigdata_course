...
def task_a(df):
    ...
    y_1y1 = tmean_years.min()['Year']
    y_2y2 = tmean_years.max()['Year']
    print(y_1y1 + y_2y2)
    pass
...
def task_b(df):
    ...
    year_with_max_days = aggregated[(aggregated['avg_day'] == aggregated['avg_day'].max())].min()['Year']
    print(year_with_max_days)
